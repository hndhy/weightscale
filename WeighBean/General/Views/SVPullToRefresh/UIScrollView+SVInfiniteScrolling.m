...
- (UIActivityIndicatorView *)activityIndicatorView {
    if(!_activityIndicatorView) {
      ...
      _activityIndicatorView.origin = CGPointMake(110.0f, 10.0f);
...
- (UILabel *)titleLabel {
  if(!_titleLabel) {
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(135.0f, 10.0f, 102.0f, 20.0f)];//{56, 17}
    _titleLabel.text = @"正在载入";//NSLocalizedString(@"Loading",);
