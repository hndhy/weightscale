...
- (void)initView
{
    ...
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, DEVICEW, 50)];
...
- (void)addTag
{
    ...
    CheckInChooseTagViewController *vc = [[CheckInChooseTagViewController alloc] initWithImage:cropped];
...
- (void)releaseImg
{
    ...
    if (self.image != nil){
        ...
        [self.listModel uploadDakaWithImage:cropped];
}
